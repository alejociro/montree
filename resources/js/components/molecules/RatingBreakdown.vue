...
const pct = (n: number) => (total.value === 0 ? 0 : Math.round((n / total.value) * 100));
</script>
...
<template>
    <div class="space-y-3">
        <div class="flex items-baseline gap-2">
            ...
            <span class="text-sm text-muted-foreground">({{ count }} reseñas)</span>
        </div>
        <div class="space-y-1">
            <div
            ...
            >
                ...
                <div class="h-2 flex-1 overflow-hidden rounded bg-muted">
                    <div
                        ...
                        :style="{ width: pct(distribution[String(star) as keyof typeof distribution]) + '%' }"
                    />
                </div>
