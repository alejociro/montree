    ...
    >
        ...
        <div class="max-w-md space-y-3">
            ...
            <h1 class="text-2xl font-semibold tracking-tight">
                {{ $t('Esta dirección no corresponde a ninguna agencia') }}
            </h1>
            <p class="text-sm text-muted-foreground">
                {{
                    $t(
                        'Es posible que el subdominio esté mal escrito o que la agencia ya no esté activa en MONTREE.',
                    )
                }}
            </p>
        </div>
