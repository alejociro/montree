...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-card p-6 text-foreground lg:justify-center lg:p-8"
    >
        <header
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-ring"
                >
                    {{ $t('Dashboard') }}
                </Link>
                <template v-else>
                    <Link
                        :href="login()"
                        class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-foreground hover:border-border"
                    >
                        {{ $t('Log in') }}
                    </Link>
                    <Link
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span class="relative bg-card py-1">
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-card shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]"
                                >
                                    <span
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-destructive underline underline-offset-4"
                                >
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-border bg-brand-ink px-5 py-1.5 text-sm leading-normal text-brand-cream hover:bg-brand-green"
                            >
                                {{ $t('Deploy now') }}
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-destructive/10 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <!-- Laravel Logo -->
                    <svg
                        class="w-full max-w-none translate-y-0 text-destructive opacity-100 transition-all duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    >
                        <g
                            class="text-foreground opacity-100 mix-blend-darken transition-all delay-300 duration-750 dark:mix-blend-normal starting:opacity-0"
                        >
                            <mask
                                id="path-1-mask"
                        ...
                        <g
                            class="text-brand-on-ink opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[26px]"
                        >
                            <mask
                                id="path-2-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-brand-drop opacity-100 mix-blend-color transition-all delay-400 duration-750 dark:mix-blend-hard-light starting:opacity-0 motion-safe:starting:-translate-x-[51px]"
                        >
                            <mask
                                id="path-3-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-brand-on-ink opacity-100 mix-blend-multiply transition-all delay-400 duration-750 dark:mix-blend-normal starting:opacity-0 motion-safe:starting:-translate-x-[78px]"
                        >
                            <mask
                                id="path-4-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-brand-on-ink opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[102px]"
                        >
                            <mask
                                id="path-5-mask"
                                maskUnits="userSpaceOnUse"
