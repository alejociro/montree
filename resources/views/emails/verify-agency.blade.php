...
<head>
    <meta charset="UTF-8">
    <title>{{ __('Activa tu agencia en MONTREE') }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 8px 0;font-size:13px;color:#6b7280;line-height:1.6;">
                                {{ __('Este enlace expira en :minutes minutos. Si no creaste esta cuenta, puedes ignorar este correo.', ['minutes' => $expiresInMinutes]) }}
                            </p>
                        </td>
                    </tr>
                </table>
